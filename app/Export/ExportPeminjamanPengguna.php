...
class ExportPeminjamanPengguna implements FromCollection, WithHeadings, WithMapping, WithStyles
{
    ...
    public function collection()
    {
        return peminjaman::select(
            ...
            ->where('peminjaman.id_pengguna', Auth::user()->id_pengguna) // filter sesuai user login
            ->get();
    }
