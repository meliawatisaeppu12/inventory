...
<div class="card">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="datetme-local" class="form-control @error('batas_peminjaman') is-invalid @enderror" name="batas_peminjaman" value="{{ $peminjaman->batas_peminjaman }}" id="batas_peminjaman">
