...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route ('staff.peminjaman.update', $peminjaman->id_peminjaman)}}" method="post">
            @csrf

            <div class="row mb-3">
                <label for="code_semester" class="col-sm-2 col-form-label">Detail Kegiatan</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="datetame-local" class="form-control @error('batas_peminjaman') is-invalid @enderror" name="batas_peminjaman" value="{{ $peminjaman->batas_peminjaman }}" id="batas_peminjaman">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{ auth()->guard('staff')->user()->nama_pengguna }}" readonly>
